#pragma checksum "E:\AIIF\SegAll\ENTERPRISE\WEB\BACK\NET\EJERCICIOS\EXIWARE\EXIWARE\Pages\Shared\Admin\_AdminAll\_AdminModify.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f9ef15da3a16db7e782f7bc0dfd2380589a4f15e"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f9ef15da3a16db7e782f7bc0dfd2380589a4f15e", @"/Pages/Shared/Admin/_AdminAll/_AdminModify.cshtml")]
        ...
        <tr>
            ...
            <td>
                <div class=""md-form my-0"">
                    <input class=""form-control form-control-sm"" type=""checkbox"" 
              ");
            WriteLiteral(@"          id=""ID_Mod_Admin_6"">
                </div>
            </td>
        </tr>
    </table>
...
<script>
        ...
        http.onreadystatechange = function(){
            ...
            if(http.status == 200) {
                if( http.responseText.indexOf(""Fail"")<0 ){
                    ...
                    document.getEl");
            WriteLiteral(@"ementById( ""ID_Mod_Admin_0"" ).value = valuesfromuser['id_card'];
                ...
                ModalInfoShow( ""Error!!");
            WriteLiteral(@"!"", http.responseText+"""" ).onclick = function(){
                        location.reload();
                };
            }
        }
    ...
    function ModifyAdmin(){
        ...
        datas = JSON.stringify({
                    ...
                    state:document.getElementById( ""ID_Mo");
            WriteLiteral(@"d_Admin_5"" ).value+"""",
